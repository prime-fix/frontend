...
export class Diagnostic implements BaseEntity {
   ...
   * @property {string} diagnostic.state_diagnostic - The state of the diagnostic.
   ...
   */
  constructor(diagnostic: { id_diagnostic: string; price: number; id_vehicle: string; state_diagnostic: string; diagnosis: string; id_expected: string }) {
    this._id_diagnostic = diagnostic.id_diagnostic;
    this._price = diagnostic.price;
    this._id_vehicle = diagnostic.id_vehicle;
    this._state_diagnostic = diagnostic.state_diagnostic;
  ...
  get state_diagnostic(): string { return this._state_diagnostic; }
  set state_diagnostic(state_diagnostic: string) { this._state_diagnostic = state_diagnostic; }
